...
const ShadowsPanel = () => {
  ...
  const [time, setTime] = useState('12:00'); // Format HH:MM
  ...
  const [darkness, setDarkness] = useState(50);   // 0-100
    ...
    <AccordionItem value="item-shadows">
      ...
      <AccordionContent className="space-y-3 p-1 text-xs">
        <div className="flex items-center justify-between p-1">
          <Label htmlFor="shadows-enabled" className="font-medium">Enable Shadows (WIP)</Label>
